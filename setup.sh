...
apt-get update
apt-get install --reinstall -y git iptables easy-rsa gawk knot-resolver idn sipcalc python3-pip  diffutils socat lua-cqueues ipset irqbalance
...
# Перезагружаем
echo
echo -e '\e[1;32mAntiZapret-Core VPN installed successfully!\e[0m'
echo 'Rebooting...'
