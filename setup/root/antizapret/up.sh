...
ip addr add 1.9.8.4/32 dev lo || true
...
iptables -w -t nat -A PREROUTING -d 19.84.0.0/15 -j ANTIZAPRET-MAPPING
ip6tables -w -t nat -A PREROUTING -d fd00:19:84::/112 -j ANTIZAPRET-MAPPING
