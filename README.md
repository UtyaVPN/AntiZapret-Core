...
| `ROUTE_AGGREGATION_LIMIT` | `число` | Лимит количества маршрутов (по умолчанию 300). 0 для отключения. |
...
## Агрегация маршрутов
AntiZapret-Core автоматически объединяет мелкие подсети в более крупные, чтобы итоговое количество маршрутов не превышало заданный лимит (параметр `ROUTE_AGGREGATION_LIMIT`, по умолчанию **300**).
